...
import { loadDashboardFixtures, type DashboardFixtures } from './fixturesLoader'
...
export class Module extends BaseModule {
  ...
  private fixtures!: DashboardFixtures
  ...
  public async init(): Promise<BaseModule> {
    ...
    this.fixtures = loadDashboardFixtures(
      this.moduleName,
      this.config.fixtures_path as string | undefined,
    )
  ...
  const modules: any = Object.values(codebaseUiModules).reduce(
    ...
    const cPresets = this.fixtures.controlPresets.filter((cp: any) =>
  ...
  async appendMissingPresets() {
    ...
    this.fixtures.tabPresets.forEach((tp: any) => {
    ...
    this.fixtures.controlPresets.forEach((cp: any) => {
