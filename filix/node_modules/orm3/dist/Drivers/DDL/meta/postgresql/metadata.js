...
exports.PostgresMetadataDriver = void 0;
...
class PostgresMetadataDriver {
    ...
    async getColumns(tableName) {
      ...
      WHERE c.table_schema = ${schemaExpr}
        ...
        return rows.map((row) => new column_1.PgColumn(row));
    }
    async getIndexes(tableName) {
      ...
      WHERE b.table_schema = ${schemaExpr}
        ...
        const rows = await this.exec(sql);
        return rows.map((row) => new index_1.PgIndex(row));
    }
    async close() {
...
exports.PostgresMetadataDriver = PostgresMetadataDriver;
