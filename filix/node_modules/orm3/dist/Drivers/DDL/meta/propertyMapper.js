...
exports.mapColumnToProperty = mapColumnToProperty;
...
function isIntegerType(dataType) {
    return (dataType.includes('int') && !dataType.includes('point') && !dataType.includes('interval')) || dataType === 'serial' || dataType === 'bigserial' || dataType === 'smallserial';
}
function isNumberType(dataType) {
    return (dataType.includes('decimal') ||
...
function includesTimeComponent(dataType) {
...
function isBinaryType(dataType) {
    return (dataType.includes('blob') ||
...
function coerceDefaultValue(raw, type) {
