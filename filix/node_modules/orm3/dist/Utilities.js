...
const comparatorMap = {
    '>': (value) => SQLQuery_1.default.gt(value),
    gt: (value) => SQLQuery_1.default.gt(value),
    '>=': (value) => SQLQuery_1.default.gte(value),
    gte: (value) => SQLQuery_1.default.gte(value),
    '<': (value) => SQLQuery_1.default.lt(value),
    lt: (value) => SQLQuery_1.default.lt(value),
    '<=': (value) => SQLQuery_1.default.lte(value),
    lte: (value) => SQLQuery_1.default.lte(value),
    '!': (value) => SQLQuery_1.default.ne(value),
    '!=': (value) => SQLQuery_1.default.ne(value),
    ne: (value) => SQLQuery_1.default.ne(value),
    between: (value) => Array.isArray(value) ? SQLQuery_1.default.between(value[0], value[1]) : SQLQuery_1.default.between(value.from, value.to),
    not_between: (value) => Array.isArray(value) ? SQLQuery_1.default.not_between(value[0], value[1]) : SQLQuery_1.default.not_between(value.from, value.to),
    not_in: (value) => SQLQuery_1.default.not_in(value)
};
...
function normalizeConditionValue(value) {
    ...
    if (value.hasOwnProperty('sql_comparator')) {
        return value;
    }
    ...
    if (keys.length === 1) {
        ...
        if (comparatorFn) {
            const normalizedOperand = normalizeConditionValue(value[key]);
    ...
    const normalized = {};
    for (const key of keys) {
        normalized[key] = normalizeConditionValue(value[key]);
    }
    return normalized;
}
/**
...
function wrapFieldObject(params) {
    ...
    const newObj = {};
    let newProp;
    const propPreDefined = params.model.properties[params.field];
    const modelIdField = Array.isArray(params.model.id) ? params.model.id[0] : params.model.id;
