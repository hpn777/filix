...
export interface IDriver {
     ...
     */
    find(columns: string[], table: string, conditions: Record<string, unknown>, options: DriverOptions): Promise<DriverResult[]>;
    /**
     * Insert or update a record
     */
    save(table: string, data: Record<string, unknown>): Promise<DriverResult>;
    /**
     * Delete records
     */
    remove(table: string, conditions: Record<string, unknown>): Promise<void>;
    /**
     ...
     */
    exists(table: string, conditions: Record<string, unknown>): Promise<boolean>;
    /**
     ...
     * Execute raw query
     */
    execQuery(query: string, params?: unknown[]): Promise<DriverResult[]>;
    /**
     ...
     */
    aggregate(table: string, func: string, column: string, conditions?: Record<string, unknown>): Promise<unknown>;
    /**
...
export interface IQueryBuilder {
     ...
     */
    buildSelect(columns: string[], table: string, conditions: Record<string, unknown>, options: DriverOptions): BuiltQuery;
    /**
     * Build an INSERT query
     */
    buildInsert(table: string, data: Record<string, unknown>): BuiltQuery;
    /**
     * Build an UPDATE query
     */
    buildUpdate(table: string, data: Record<string, unknown>, conditions: Record<string, unknown>): BuiltQuery;
    /**
     * Build a DELETE query
     */
    buildDelete(table: string, conditions: Record<string, unknown>): BuiltQuery;
    /**
     * Build a COUNT query
     */
    buildCount(table: string, conditions: Record<string, unknown>): BuiltQuery;
}
/**
