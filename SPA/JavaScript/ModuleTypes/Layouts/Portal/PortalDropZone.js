Ext.define('ExtModules.Layouts.Portal.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        ExtModules.Layouts.Portal.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    notifyOver: function(dd, e, data) {
        ...
        if (overColumn.xtype != 'splitter') {
			var portlets = overColumn.items.items;
			var overSelf = false;
        	...
        	if (portal.fireEvent('validatedrop', overEvent) !== false && portal.fireEvent('beforedragover', overEvent) !== false) {
        		...
        		dd.panelProxy.getProxy().setWidth(overColumn.width);
        		if (overPortlet) {
    ...
    unreg: function() {
        ...
        ExtModules.Layouts.Portal.PortalDropZone.superclass.unreg.call(this);
    }
});
